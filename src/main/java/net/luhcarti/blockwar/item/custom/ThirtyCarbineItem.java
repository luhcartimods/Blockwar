...
public class ThirtyCarbineItem extends Item {
    public ThirtyCarbineItem(Properties pProperties) {
        super(pProperties);
    }
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (!pLevel.isClientSide) {
            ThirtyCarbineProjectileEntity dice = new ThirtyCarbineProjectileEntity(pLevel, pPlayer);
